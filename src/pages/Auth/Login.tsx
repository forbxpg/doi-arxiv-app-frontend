  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
        ...
        <div
          className="absolute bottom-10 right-10 w-96 h-96 bg-gradient-to-br from-purple-400/20 to-pink-400/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-br from-indigo-400/10 to-blue-400/10 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[800px] w-full space-y-8">
          ...
          <div className="text-center">
            <div className="group relative mx-auto w-20 h-20 flex items-center justify-center rounded-3xl bg-gradient-to-br from-blue-500 to-purple-600 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-110 hover:rotate-3">
              <Loader2 className="w-10 h-10 text-white group-hover:scale-110 transition-transform duration-300" />
              ...
              <div
                className="absolute -bottom-2 -left-2 w-4 h-4 bg-gradient-to-br from-green-400 to-teal-500 rounded-full animate-ping"
                style={{ animationDelay: "0.5s" }}
              ></div>
            </div>
            <h2 className="mt-6 text-4xl font-bold text-gray-900 dark:text-white bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Добро пожаловать
            </h2>
          ...
          {/* Login Form */}
          <div className="group relative overflow-hidden bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/20 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 shadow-2xl rounded-3xl border border-blue-100/50 dark:border-gray-600 hover:shadow-3xl transition-all duration-500">
            ...
            <form className="relative p-8 space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      autoComplete="email"
                      required
                      className="w-full pl-12 pr-4 py-4 border border-gray-200/50 dark:border-gray-600 rounded-2xl bg-gray-50/80 dark:bg-gray-700/80 backdrop-blur-sm text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm hover:shadow-md transition-all duration-300"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center group">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-gray-600 rounded bg-gray-50 dark:bg-gray-700 transition-colors duration-300"
                    />
                    <label
                      htmlFor="remember-me"
                      className="ml-3 block text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-gray-100 transition-colors duration-300"
                    >
                      Запомнить меня
                    </label>
                  </div>
              ...
              <div>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="group relative w-full flex justify-center items-center space-x-2 py-4 px-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 active:from-blue-800 active:to-purple-800 text-white rounded-2xl font-semibold transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] hover:shadow-xl hover:shadow-blue-500/30 active:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                >
                  {isLoading ? (
                    <>
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <Link
                    to="/auth/register"
                    className="font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300 transition-colors duration-300 hover:underline"
                  >
                    Зарегистрироваться
                  </Link>
                </p>
          ...
          <div className="text-center">
            ...
            >
              ...
              <div
                className="absolute -bottom-1 -left-1 w-2 h-2 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"
